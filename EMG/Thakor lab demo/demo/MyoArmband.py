...
class MyoArmband:
    ...
    def __init__(self, name = 'MyoArmband', mac = 'eb:33:40:96:ce:a5'):
        """
        Constructor
    ...
    async def _stream(self, loop):
        ...
        for i in range( 0, 5 ):
            retry = False
            try:
                async with BleakClient( self._mac, loop = loop ) as client:
                    # enable data streams
...
if __name__ == '__main__':
    ...
    class_init = inspect.getfullargspec( MyoArmband.__init__ )

...
Updated to receive UDP from ALC Device.  Typical parameters are:

16 Channels at 500Hz, 10 samples per UDP packet

Data is pre-filtered so no additional filtering needed.

Typical units are on the order of 5e-6 at rest.  Ensure gain and/or feature
thresholds are updated accordingly!




====================================
Pre-2023 This class was meant to interface with the Intan Dev Board (FPGA)




In order to enable Intan UDP interface to the MiniVIE, please see the modifications required below for the 
